...
import PossibleRewards from '../PossibleRewards/PossibleRewards';
...
const RouletteContainer = forwardRef(({ onWin, onOpenCase, onSpinningChange, onRouletteShowingChange }, ref) => {
  ...
  return (
    <>
      ...
      {/* PossibleRewards всегда показывается в компьютерной версии, скрывается только на мобильных при показе рулетки */}
      {(!isMobile || !showRoulette) && <PossibleRewards />}
    </>
  );
});
